...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'input.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/input.html'`` the file from the app1 package is loaded,
    by loading ``'app2/input.html'`` the file from the second.
    """
